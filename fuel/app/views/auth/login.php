<div data-uk-scrollspy="{cls:'uk-animation-scale-up', delay:300, repeat: true}">
	...
	<center><h1 class="uk-article-title">～ 水ロケット管理システム ～</h1></center>
</div>
<br>
<?php echo Form::open(array('action' => 'auth/login', 'class' => 'uk-form')); ?>
		...
		<center>
			<div data-uk-scrollspy="{cls:'uk-animation-slide-right', delay:600, repeat: true}">
				<div class="uk-form-row">
					<?php echo Form::input('authname', '', array('placeholder' => 'ID　入力', 'class' => 'uk-text-center', 'type' => 'text')); ?>
				</div>
				<br>
			</div>
			<div data-uk-scrollspy="{cls:'uk-animation-slide-left', delay:600, repeat: true}">
				<div class="uk-form-row">
					<?php echo Form::input('password', '', array('placeholder' => 'Password　入力', 'class' => 'uk-text-center', 'type' => 'password')); ?>
				</div>
			</div>
		</center>
	</fieldset>
	<br><br>
	<center>
		<button class="uk-button uk-button-primary uk-button-large">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-sign-in"></i>&nbsp;&nbsp;ログイン&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
	</center>
<?php echo Form::close(); ?>
<?php
/*
