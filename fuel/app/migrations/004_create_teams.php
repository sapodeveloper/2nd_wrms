...
class Create_teams
{
	public function up()
	{
		\DBUtil::create_table('teams', array(
			...
			'leader_name' => array('constraint' => 50, 'type' => 'varchar', 'null' => true),
			'teammate1_name' => array('constraint' => 50, 'type' => 'varchar', 'null' => true),
			'teammate2_name' => array('constraint' => 50, 'type' => 'varchar', 'null' => true),
